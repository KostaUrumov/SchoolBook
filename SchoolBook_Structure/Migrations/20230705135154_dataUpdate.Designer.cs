...
namespace SchoolBook_Structure.Migrations
{
    ...
    [Migration("20230705135154_dataUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamStudent", b =>
                {
                    ...
                    b.HasKey("ExamsId", "StudentsstudentId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7145f2f3-1d68-4914-918d-870ab81ea581",
                            Name = "Principal",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "25c3d486-4db5-4a2b-9d97-b768498192e4",
                            Name = "Teacher",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "cda54224-4b91-482f-a030-70785fdba753",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "21ac61e5-ab7e-4b26-89cd-05f55d0260f2",
                            Name = "Parent",
            ...
            modelBuilder.Entity("SchoolBook_Structure.Entities.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExamStudent", b =>
                {
                    b.HasOne("SchoolBook_Structure.Entities.Exam", null)
                        .WithMany()
                        .HasForeignKey("ExamsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolBook_Structure.Entities.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolBook_Structure.Entities.Student", b =>
                {
                    b.HasOne("SchoolBook_Structure.Entities.Parent", "Parent")
                        .WithMany("MyKids")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
